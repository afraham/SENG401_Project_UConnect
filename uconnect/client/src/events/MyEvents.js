	...
	const handleDeleteEvent = async (event) => {
		try {
			const response = await fetch(
				`https://u-connect-server.vercel.app/api/events/delete/${event._id}`,
				{
					method: "DELETE",
					headers: {
  ...
  */
	const handlePendingButton = async (eventId) => {
		try {
			...
			const response = await fetch(
				`https://u-connect-server.vercel.app/api/events/cancelPending/${eventId}`,
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
  ...
  */
	const handleLeaveButton = async (event) => {
		try {
			...
			const response = await fetch(
				`https://u-connect-server.vercel.app/api/events/leave/${event._id}`,
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
  ...
  */
	const fetchPendingEvents = async () => {
		try {
			...
			if (userEmail) {
				const response = await fetch(
					`https://u-connect-server.vercel.app/api/pendingEventsByEmail?userEmail=${userEmail}`
				);
				if (!response.ok) {
  ...
  */
	const fetchJoinedEvents = async () => {
		try {
			...
			if (userEmail) {
				const response = await fetch(
					`https://u-connect-server.vercel.app/api/joinedEventsByEmail?userEmail=${userEmail}`
				);
				if (!response.ok) {
					throw new Error(`HTTP error! status: ${response.status}`);
				}
  ...
  */
	const fetchEvents = async () => {
		try {
			...
			if (userEmail) {
				const response = await fetch(
					`https://u-connect-server.vercel.app/api/eventsByEmail?userEmail=${userEmail}`
				);
				if (!response.ok) {
					throw new Error(`HTTP error! status: ${response.status}`);
				}
